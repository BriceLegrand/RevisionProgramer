...
class ProgramManager(object):
    def __init__(self):
        ...
        self.intervals = {
            "EASY PEASY": [0, 10, 30, 90, 150, 200, 250, 300, 350, 400],
            "SO SO": [0, 3, 10, 30, 90, 150, 200, 250, 300, 350, 400],
            "DIFFICULT": [0, 3, 10, 30, 60, 100, 150, 200, 250, 300, 350,400],
            "REALLY DIFFICULT": [0, 3, 10, 30, 60, 100, 150, 200, 250, 300, 350,400]
        }
