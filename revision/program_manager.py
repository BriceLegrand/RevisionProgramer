...
class ProgramManager(object):
    def __init__(self):
        ...
        self.intervals = {
            "EASY PEASY": [0, 7, 23, 40, 60, 60, 60, 60, 60, 60],
            "SO SO": [0, 3, 7, 20, 45, 60, 60, 60, 60, 60, 60],
            "DIFFICULT": [0, 3, 7, 20, 30, 60, 60, 60, 60, 60, 60,60],
            "REALLY DIFFICULT": [0, 3, 7, 20, 30, 45, 60, 60, 60, 60, 60, 60]
        }
